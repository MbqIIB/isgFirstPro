...
(
   -- ID NUMBER(20,0) NOT NULL,
    ...
    APPDATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP NULL,
    CARDTYPECODE VARCHAR(30 BYTE) NULL,
...
CREATE TABLE iloan.CREDITCARD(
   -- ID NUMBER(20,0) NOT NULL,
    ...
    EXISTINGCARD VARCHAR(10 BYTE) DEFAULT NULL,
    OTHERCARD VARCHAR(10 BYTE) DEFAULT NULL
...
(
    ...
    MIN_AMOUNT VARCHAR(1 BYTE) DEFAULT '1' NOT NULL ,
    TOTAL_AMOUNT VARCHAR(1 BYTE) DEFAULT '0' NOT NULL 
);
...
(
   -- ID NUMBER(20,0) NOT NULL,  
    ...
    DRIVER_LICENSE VARCHAR(20 BYTE) NULL,
    PASSPORT_NUM VARCHAR(20 BYTE) NULL,
	PRC_ID VARCHAR(20 BYTE) NULL,
	OTHER_ID VARCHAR(20 BYTE) NULL,
    PERSON_REF_NAME VARCHAR(30 BYTE) NULL,
    PERSON_REF_REL VARCHAR(20 BYTE) NULL,
...
ALTER TABLE iloan.FUND ADD CONSTRAINT FUND_fk1 FOREIGN KEY (JOB_DETAIL_ID) REFERENCES iloan.JOB_DETAIL;
