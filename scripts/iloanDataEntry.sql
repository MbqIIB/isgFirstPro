...
ALTER TABLE iloan.CREDITCARD add CONSTRAINT CREDITCARD_pk PRIMARY KEY (CREDITCARDID);		
ALTER TABLE iloan.APPLICATION ADD CONSTRAINT APPLICATION_pk PRIMARY KEY (APPID)  ;
ALTER TABLE iloan.PERSONALDATA ADD CONSTRAINT PERSONALDATA_pk PRIMARY KEY (PERSONALDATAID)  ;
ALTER TABLE iloan.ADDRESS ADD CONSTRAINT ADDRESS_pk PRIMARY KEY (ADDRESS_ID)  ;
ALTER TABLE iloan.JOB_DETAILS ADD CONSTRAINT JOB_DETAILS_pk PRIMARY KEY (JOB_DETAIL_ID)  ;
ALTER TABLE iloan.SUPPLEMENTARY ADD CONSTRAINT SUPPLEMENTARY_pk PRIMARY KEY (SUPPID)  ;
...
ALTER TABLE iloan.DOA ADD CONSTRAINT DOA_pk PRIMARY KEY (SS_ID)  ;
ALTER TABLE iloan.FUND ADD CONSTRAINT FUND_pk PRIMARY KEY (FUNDID)  ;
  
ALTER TABLE iloan.CREDITCARD ADD CONSTRAINT CREDITCARD_fk FOREIGN KEY (APPID) REFERENCES iloan.APPLICATION;
ALTER TABLE iloan.PERSONALDATA ADD CONSTRAINT PERSONALDATA_fk FOREIGN KEY (APPID) REFERENCES iloan.APPLICATION;
ALTER TABLE iloan.ADDRESS ADD CONSTRAINT ADDRESS_fk1 FOREIGN KEY (SUPPID) REFERENCES iloan.SUPPLEMENTARY; 
ALTER TABLE iloan.ADDRESS ADD CONSTRAINT ADDRESS_fk2 FOREIGN KEY (PERSONALDATAID) REFERENCES iloan.PERSONALDATA;
ALTER TABLE iloan.ADDRESS ADD CONSTRAINT ADDRESS_fk3 FOREIGN KEY (JOB_DETAIL_ID) REFERENCES iloan.JOB_DETAILS;
ALTER TABLE iloan.JOB_DETAILS ADD CONSTRAINT JOB_DETAILS_fk FOREIGN KEY (APPID) REFERENCES iloan.APPLICATION;
ALTER TABLE iloan.SUPPLEMENTARY ADD CONSTRAINT SUPPLEMENTARY_fk FOREIGN KEY (APPID) REFERENCES iloan.APPLICATION;
ALTER TABLE iloan.INSTRUCTION ADD CONSTRAINT INSTRUCTION_fk FOREIGN KEY (APPID) REFERENCES iloan.APPLICATION;
ALTER TABLE iloan.SAVEANDSWIPE ADD CONSTRAINT SAVEANDSWIPE_fk1 FOREIGN KEY (SS_ID) REFERENCES iloan.DOA;
ALTER TABLE iloan.SAVEANDSWIPE ADD CONSTRAINT SAVEANDSWIPE_fk2 FOREIGN KEY (APPID) REFERENCES iloan.APPLICATION;
--commit;
